...
\titlegraphic{\includegraphics[height = 1.5cm]{figures/nju-logo-purple.png}~\includegraphics[height = 1.5cm]{figures/cs-logo.jpg}}
% \institute{\includegraphics[height = 1.5cm]{figures/nju-logo-purple.png}~\includegraphics[height = 1.5cm]{figures/cs-logo.jpg}\\\vspace{8pt}{\footnotesize 南京大学软件所}}
\institute{南京大学软件所}
\date{\zhtoday}
