  ...
  \mdf{red}{blue}{对 VPC 问题的系统研究}{teal}{
	\begin{enumerate}
	  ...
	  \item \npcn{} 结果有助于理解弱一致性模型的复杂度
		\pause
	  \item 较早关注``弱一致性模型验证''问题 {\small (\textcolor{red}{2013$\sim$})}
		\begin{itemize}
		  \item 强: \citeinbeamer{Gibbons}{SICOMP}{97} \citeinbeamer{Cantin}{TPDS}{05} \citeinbeamer{Golab}{PODC}{11} 
		  \item 弱: \citeinbeamer{Furbach}{ACSD}{14} \citeinbeamer{Bouajjani}{arXiv}{16}
		\end{itemize}
	\end{enumerate}
  }
\end{frame}
