...
\begin{frame}{工作概述}
  \fignocaption{width = 0.85\textwidth}{figures/work-1+3-framework.pdf}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\subsection{VPC: Pipelined-RAM 一致性验证}

\begin{frame}{在研究框架中的位置}
  \fig{width = 0.80\textwidth}{figures/vpc-1+3-framework.pdf}{VPC --- Pipelined-RAM 一致性验证.}
\end{frame}
...
\begin{frame}{在研究框架中的位置}
  \fig{width = 0.80\textwidth}{figures/pa2am-1+3-framework.pdf}{2AM --- Atomicity 一致性维护与量化.}
\end{frame}
...
\begin{frame}{在研究框架中的位置}
  \fig{width = 0.80\textwidth}{figures/rvsi-1+3-framework.pdf}{RVSI --- Snapshot Isolation 一致性弱化与维护}
\end{frame}
