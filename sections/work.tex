  ...
  \begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
	  \begin{tabular}{cc|c|c|c|c|}
		...
		& \cellcolor{olive!60}{\begin{tabular}[c]{@{}c@{}}{\small 探索阶段}\\ {(RVSI)}\end{tabular}} \\ \cline{1-4} \cline{6-6}

		\multicolumn{1}{|c|}{\multirow{2}{*}[-1em]{\textbf{\idearm{}}}} & 验证 
		& \begin{tabular}[c]{@{}c@{}}{\small 典型模型}\\ {\small 理论全面}\end{tabular} 
		& \cellcolor{olive!60}{\begin{tabular}[c]{@{}c@{}}{\small 弱模型验证}\\ {(VPC)}\end{tabular}}
		& 
		...
		& \cellcolor{olive!60}{\begin{tabular}[c]{@{}c@{}}{\small 量化协议}\\ {(PA2AM)}\end{tabular}}
		&  
